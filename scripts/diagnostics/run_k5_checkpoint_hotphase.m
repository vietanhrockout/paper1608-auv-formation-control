...
paths = project_paths();
diary(fullfile(paths.diagnostics, 'k5_checkpoint_console.txt'));
...
X_hot_end = X_hot(end,:).';
save(fullfile(paths.diagnostics, 'k5_hotphase_checkpoint.mat'), 'X_hot_end', 'hot_stats', 'params', 'sat_cfg', 'cfg');
